...
# list1 = pd.read_csv('train_stances.csv', sep=",") 
# list2 = pd.read_csv('train_bodies.csv', sep=",") 

# merge = pd.merge(list1, list2,on='Body ID')
# merge.to_csv('merge_traindata.csv')

data = pd.read_csv("merge_traindata.csv")
...
data.to_csv("merge_traindata.csv",index=False)