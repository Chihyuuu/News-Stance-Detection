...
X4 = dict_vec.fit_transform(LIWC.values())
X4 = pd.DataFrame(X4.toarray(),columns = dict_vec.get_feature_names())
# print ("X4",X4) #(75385 rows x 64 columns)
X = pd.concat([X,X4],axis=1)
# print ("X",X) #(75385 rows x 7580 columns)
del X4
